...
const DataScienceBackgroundDark = () => {
    ...
    const updateAndRender = () => {
      ...
      particlesRef.current.forEach(p => {
        ...
        if (p.history.length > 1) {
          ...
          ctx.strokeStyle = 'rgba(238, 238, 238, 0.06)';
...
export default DataScienceBackgroundDark;
